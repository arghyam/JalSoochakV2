...
- **Introduction**: Purpose, scope, and DPG principles.
- **Users and Tenancy**: Multi-tenant model and user roles.
- **Functional Overview**: Core modules and features.
- **Technical Architecture**: Microservices, data flows, and services.
- **Deployment Architecture**: Cloud-neutral Kubernetes setup.
...
For setup and contribution guidelines, see the main project repository.